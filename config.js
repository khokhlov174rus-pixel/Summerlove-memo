...
window.GAME_CONFIG = {
    ...
    game: {
        ...
        winMessage: "Это было мощно!🔥<br>Ты покорил игру и сердце SUMMERLOVE — скидка 1000₸ твоя по промокоду {PROMO_CODE}.<br><br>Ол күшті болды!🔥<br>Сіз SUMMERLOVE ойыны мен жүрегін бағындырдыңыз — {PROMO_CODE} промо-коды арқылы 1000₸ жеңілдік сіздікі.",
        promoCode: "SUMMER",
        restartButtonText: "Играть заново<br>қайта ойнаңыз"
    },
